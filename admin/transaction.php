...
<body>
    ...
    <div class="alert alert-info">
        <table class="table table-hover">
            ...
            <tbody>
                <?php
                $query = $conn->query("SELECT * FROM transaction LEFT JOIN customer ON customer.customerid = transaction.customerid") or die(mysqli_error($conn));
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        if($o_stat == 'Confirmed'){
                            echo '<a href="receipt.php?tid=' . $id . '">View</a>';
                        ...
                        <?php
                        if($o_stat == 'Confirmed'){
                            // Do nothing for Confirmed status
                        } elseif($o_stat == 'Cancelled'){
                            // Do nothing for Cancelled status
                        } else {
